...
export default class MakeOffer1 extends React.Component {
            ...
            <BackGround>
                <View style={styles.scene}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingVertical: 10}}
                        ...
                        <TextViewMedium FontPaddingVertical={heightPercentageToDP(5)} value="Your Offer"
                                        FontSize={Globals.TEXT_SIZE.MEDIUM_2} FontColor={Globals.COLOR.DARKBLUE}
